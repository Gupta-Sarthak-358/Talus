...
<!-- Vendored 2026-09-15 from https://github.com/jshsakura/awesome-opencode-skills (port of VoltAgent/awesome-codex-subagents). Vetted: guidance-only, no executable code, no network/exfiltration instructions, no prompt-injection markers. -->
