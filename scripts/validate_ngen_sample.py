...
def main() -> int:
    ...
    print("road/river distances, NDVI, all six DEM derivatives, soil")
    print("moisture and labels are REAL-verified (IMD/Overpass/Sentinel-2/")
    print("USGS/CCI/Bhusanket); drain density is PROXY (measured window);")
    print("lulc/lithology/lineament are STUB/demo until a real source is")
    print("committed and checksummed.")
