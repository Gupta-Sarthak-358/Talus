...
def main() -> int:
    ...
    print("S1-S4 road/river distances and S1-S4 NDVI are REAL-verified, S1")
    print("DEM derivatives + drain + TWI/SPI and S2-S4 DEM derivatives are")
    print("PROXY (open mirror / measured window, not USGS/Bhusanket-grade),")
    print("and soil/lulc/lithology/lineament/labels are STUB/demo until a")
    print("real source (USGS SRTM tile, ERA5 request, Bhusanket export,")
    print("classifier LULC) is committed and checksummed.")
