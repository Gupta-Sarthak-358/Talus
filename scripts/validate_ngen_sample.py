...
def main() -> int:
    ...
    print("road/river distances, NDVI and all six DEM derivatives are")
    print("REAL-verified (IMD/Overpass/Sentinel-2/USGS); drain density is")
    print("PROXY (measured window); soil/lulc/lithology/lineament/labels")
    print("are STUB/demo until a real source (ERA5 request, Bhusanket")
