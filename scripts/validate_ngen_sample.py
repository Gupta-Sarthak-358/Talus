...
def main() -> int:
    ...
    print("road/river distances, NDVI, all six DEM derivatives and soil")
    print("moisture are REAL-verified (IMD/Overpass/Sentinel-2/USGS/CCI);")
    print("drain density is PROXY (measured window); lulc/lithology/")
    print("lineament/labels are STUB/demo until a real source (Bhusanket")
    print("export, classifier LULC) is committed and checksummed.")
