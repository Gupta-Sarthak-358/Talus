    ...
    <div className="bg-mine-darker border border-mine-border rounded-xl p-4 shadow-sm space-y-3">
      ...
      <div className="h-44 w-full pt-1">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={history} margin={{ top: 8, right: 12, left: -24, bottom: 0 }}>
            ...
            <ReferenceLine y={65} stroke="#d96b24" strokeDasharray="3 3" opacity={0.7} />
            ...
            <Line
              ...
              stroke="#664930"
              strokeWidth={3}
              dot={{ r: 4, fill: '#664930', stroke: '#f3e9dd', strokeWidth: 2 }}
              activeDot={{ r: 6, fill: '#c74732', stroke: '#f3e9dd', strokeWidth: 2 }}
            />
          </LineChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="flex items-center justify-between text-[10px] text-mine-muted border-t border-mine-border pt-2 font-mono">
        <span className="flex items-center gap-1">
          <span className="w-2 h-0.5 bg-risk-high inline-block"></span> High Threshold (65)
        </span>
        <span className="flex items-center gap-1">
