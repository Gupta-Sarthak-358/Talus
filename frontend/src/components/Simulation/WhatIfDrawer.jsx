        ...
        <div className="flex-1 p-5 space-y-5 overflow-y-auto">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full bg-mine-darker border border-mine-border rounded-lg px-3 py-2 text-xs font-semibold text-mine-text focus:outline-none focus:border-talus-600"
            >
              {zones.map((z) => (
          ...
          <div className="space-y-2">
            <div className="text-xs font-semibold text-mine-text flex items-center justify-between">
              ...
              <span className="text-[10px] text-talus-600">Click to load</span>
            </div>
            <div className="grid grid-cols-2 gap-2">
              {WHAT_IF_PRESETS.map((preset) => (
                <button
                  ...
                  className="p-2 bg-mine-darker hover:bg-mine-dark border border-mine-border hover:border-talus-500 rounded-lg text-left transition-all"
                >
                  <div className="text-[11px] font-bold text-mine-text">{preset.name}</div>
                  <div className="text-[10px] text-mine-muted line-clamp-1 mt-0.5">{preset.expectedImpact}</div>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4 bg-mine-darker p-4 rounded-xl border border-mine-border">
            {/* 1. Rainfall Slider */}
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-mine-text flex items-center gap-1.5">
                  <CloudRain className="w-3.5 h-3.5 text-talus-600" />
              ...
              <input
                ...
                className="w-full accent-talus-600 cursor-pointer"
              />
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-mine-text flex items-center gap-1.5">
                  <GitCommit className="w-3.5 h-3.5 text-risk-critical" />
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-talus-600 hover:bg-talus-500 text-white rounded-lg text-xs font-bold transition-all shadow-sm disabled:opacity-50"
            >
            ...
            {activeSimulation && (
              <button
                ...
                className="px-3 py-2.5 bg-mine-card hover:bg-mine-dark text-mine-muted hover:text-mine-text border border-mine-border rounded-lg text-xs font-medium transition-colors"
