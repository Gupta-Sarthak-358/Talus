...
Model: RandomForestClassifier(500 trees, seed 42) + isotonic calibration; LR baseline beaten on spatial OOF (AUC 0.8983 vs 0.8947); calibrated Brier 0.118 vs naive 0.25.
