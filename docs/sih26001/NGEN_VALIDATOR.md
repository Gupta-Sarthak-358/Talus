...
*   Current sample: **6 of 17 S1 science features are REAL** (rainfall 24h/7d/30d + road/river distances + NDVI) and **5 are PROXY** (4 Terrarium-mirror DEM derivatives + drain PROXY-window) + `zone_id` REAL (frozen ID); S2–S4 road/river distances REAL; the rest remain STUB/demo. See `docs/sih26001/NGEN_PROVENANCE_S1.md` for the per-feature table and why.
