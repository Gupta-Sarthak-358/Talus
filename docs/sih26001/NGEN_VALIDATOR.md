...
*   Current sample: **all 17 science features are STUB/demo** (2 CONSTANT). Only `zone_id` is REAL (frozen ID). See `docs/sih26001/NGEN_PROVENANCE_S1.md` for the per-feature table and why.
