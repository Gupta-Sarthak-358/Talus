...
- [x] Positive/negative sampling + buffer + date-window — `>300m` `seed 42` `50:50` `season-window` `approximate` + year rescue `61` clusters `build_training_matrix.py:294`, `673/73 dated` temporal `metrics.md:32`
